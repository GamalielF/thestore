...
const Home = () => {
    ...
    return (
        <main className='flex w-full mt-[60px] min-h-screen'>
             ...
             <aside className='w-[200px] pt-12 border-[1px] bg-light-gray hidden md:block shadow-xl'>
            <button onClick={toggleCategories}
                className='border-b-2 text-2xl p-4 flex items-center gap-2 hover:scale-105 bg-gradient-to-r from-light-blue to-blue-500'>
        ...
        <section className='pt-12 mx-2 flex-grow bg-gradient-to-r from-blue-500 to-light-blue shadow-2xl'>
            {/* Search box */}
            <form className='h-[45px] max-w-2xl mx-auto px-4 mb-4 md:mb-8' onSubmit={handleSubmit}>
                <div className='flex w-full h-full border-[1px] rounded-md overflow-hidden shadow-md'>
